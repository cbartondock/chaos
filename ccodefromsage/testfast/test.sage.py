...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2p5 = RealNumber('2.5'); _sage_const_100 = Integer(100); _sage_const_128 = Integer(128); _sage_const_500 = Integer(500)
import numpy
...
maxiter = _sage_const_500 
numsamples = _sage_const_100 
grid= _sage_const_128 
...
imgplot = plt.imshow(x,vmin=_sage_const_0 , vmax=_sage_const_1 ,interpolation='nearest',cmap=cm.winter,extent=[xmin,xmax,ymin,ymax])
